window.SITE_DATA = {
  ...
  "playerNotes": {
    ...
    "Monash Uni::Kevin Chen": {
      "plays": "Right",
      "serving": "Decent 1st serve but only hits it ~20% of the time. 2nd serve is a slow slice with a big bounce.",
      "generalPlay": "Tallish Asian guy. Played doubles only. Probably a 2 on Tuesday. Lost to Shannon & DT in doubles 6-2, 7-5.",
      "strengths": "Good at rallies from the baseline",
      "weaknesses": "Struggles with serves to his backhand."
    },
    ...
    "Monash Uni::Matthew Lee": {
      "plays": "Right",
      "serving": "Bad 1st Serve % - very quick to hit his 2nd serve so ask him to slow down",
